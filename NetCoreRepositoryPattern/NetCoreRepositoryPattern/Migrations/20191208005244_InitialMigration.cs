    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "12312312", "Test", "Test" });

            migrationBuilder.InsertData(
                table: "Comedians",
                columns: new[] { "ComedianId", "ContactPhone", "FirstName", "LastName" },
                values: new object[] { 2, "12312312", "Test", "Test" });

            migrationBuilder.InsertData(
                table: "Events",
                columns: new[] { "EventId", "EventDate", "EventName", "VenueId" },
                values: new object[] { 1, new DateTime(2019, 12, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), "Test", null });

            migrationBuilder.InsertData(
                table: "Gigs",
                columns: new[] { "GigId", "ComedianId", "EventId", "GigHeadline", "GigLengthInMinutes" },
                values: new object[] { 1, 1, 1, "test", 60 });

            migrationBuilder.InsertData(
                table: "Gigs",
                columns: new[] { "GigId", "ComedianId", "EventId", "GigHeadline", "GigLengthInMinutes" },
                values: new object[] { 2, 2, 1, "test2", 45 });
